...
const Widgets = ({newsResults, newRandomUsers}) =>{
    ...
    return(
        ...
        <div className="xl:w-[600px] hidden lg:inline ml-8 space-y-5">
            <div className="w-[90%] xl:w-[75%] sticky top-0 bg-white py-1.5 z-50">
                  <div className="flex items-center p-3 rounded-full bg-red-300 border-none focus:ring-0 relative">
            ...
            <div className="sticky top-16 text-gray-700 space-y-3 bg-gray-100 pt-2 rounded-xl w-[90%] xl:w-[75%]">
                ...
                {newRandomUsers.slice(0,randomUserNum).map((randomUser) =>(
                       <div key={randomUser.login.uuid} className="flex items-center px-4 py-2 cursor-pointer hover:bg-gray-200">
                                <img width="40" className="rounded-full" src={randomUser.picture.medium} alt="user image"/>
