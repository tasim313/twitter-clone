...
const Post = ({post}) =>{
    return(
        ...
        <div className="flex p-3 cursor-pointer border-b border-gray-200">
            {/* user image */}
            <img className="h-12 w-12 rounded-full mr-4" src={post.userImg} alt={post.username}/>
            ...
            <div className="">
                ...
                <div className="flex justify-between text-gray-500 p-2">
                      <ChatBubbleOvalLeftEllipsisIcon className="h-9 hoverEffect p-2 hover:text-sky-500 hover:bg-sky-100"/>
                      ...
                      <ShareIcon className="h-9 hoverEffect p-2 hover:text-sky-600 hover:bg-sky-100"/>
